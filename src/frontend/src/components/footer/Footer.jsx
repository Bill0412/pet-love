...
export default function Footer() {
    return (
        <footer id="mainfoot" className="main-foot page-footer bg-light rounded footer-adj" style={{display: "block"}}>
            <br />
            <p className="text-center"><img src="petlove-logo.png" border="0" height="100px" /><br /><br />Pet Love NFT Market on the Internet Computer<br /><span style={{fontSize: "13px"}}>Beta Version v0.2.0</span></p>
